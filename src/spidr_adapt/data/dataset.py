...
from spidr_adapt.config import DEFAULT_CONV_LAYER_CONFIG, SAMPLE_RATE, DataConfig, MaskingConfig
from spidr_adapt.data.masks import MaskGenerator
from spidr_adapt.data.utils import bytes_from_archive, read_manifest
    ...
    *,
    ...
    batch_sampler = DistributedBatchSampler(
        BucketizeBatchSampler(
            lengths=dataset.manifest["num_frames"].to_list(),
