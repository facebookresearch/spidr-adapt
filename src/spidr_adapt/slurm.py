...
from spidr_adapt.config import SlurmConfig
from spidr_adapt.tools import write_git_info_if_available

logger = logging.getLogger()


def current_codebase_path() -> Path:
    import spidr_adapt  # noqa: PLC0415

    return Path(spidr_adapt.__file__).parent.parent
